...
print ("positive tweets that was posted on 1st june in Turkey among 1500 random tweets:")
print(count_positive)
print ("negative tweets that was posted on 1st june in Turkey among 1500 random tweets:")
print(count_negative)
